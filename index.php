...
<div class="leftContent">
    ...
    <p><b>Svar: </b> Nej, detta är första gången jag introduceras till PHP</p><br>
    <hr>
    ...
    <p><b>Svar: </b>Samtliga undersidor med Index inkluderat ligger i root katalogen. I denna katalogen
        ligger även mappar för CSS, includes och JavaScript innehållandes tillhörande filer. </p> <br>
    <hr>
    <h3>Har du följt guiden, eller skapat på egen hand?</h3>
    <p><b>Svar: </b> Jag har följt guiden ganska noga</p> <br>
    <hr>
    ...
    <p><b>Svar: </b> för att minimera antalet PHP filer i includes, så inkluderade jag alla element som är identiska över samtliga undersidor
        ...
        inser att jag säkert också kan inkludera i header.php och sedan använda CSS positon för att placera längst ner på sidan.. men vi börjar såhär! </p> <br>
    <hr>
    <h3>Vilken utvecklingsmiljö har du använt för uppgiften</h3>
    <p><b>Svar: </b> Jag har användt Wampserver 3.3.0 med PHP 8.2 som inkluderades </p><br>
    <hr>
